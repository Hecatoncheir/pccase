...
const kKits = <Kit>[
  Kit(
    ...
    description: 'Все шесть печатных деталей, крепёж, ножки и инструкция. '
  ...
  Kit(
    ...
    description: 'Фронтальная сетка с увеличенной перфорацией и '
  ...
  Kit(
    ...
    description: 'Рама бокового окна под акрил 3 мм, акрил и фурнитура '
        'в комплекте.',
    price: 3190,
    tag: '−15%',
  ...
  Kit(
    ...
    description: 'Рассеиватели подсветки и светящиеся ножки из прозрачного '
        'PETG.',
    price: 1890,
    tag: 'Под заказ',
